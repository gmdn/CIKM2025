compute_wss_at_r95_optimistique <- function(ranking, r, P_total, N_total) {
  ...
  # Extend ranking: first missing positives, then missing negatives
  ranking_full <- c(ranking, rep(1, P_missing), rep(0, N_missing))
