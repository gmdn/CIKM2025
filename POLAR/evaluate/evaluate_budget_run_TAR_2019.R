...
source("read_collection/CLEF/TAR-2019/read_qrels_CLEF_2019.R")
source("read_collection/CLEF/TAR-2019/read_topics_CLEF_2019.R")

# read runs
source("read_runs/CLEF/TAR-2019/ilps.R")

runs_all_participants <- runs

source("read_runs/CLEF/TAR-2019/padua.R")

runs_all_participants <- runs_all_participants %>%
  bind_rows(runs)

source("read_runs/CLEF/TAR-2019/sheffield.R")
